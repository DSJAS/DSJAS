...
const tableColumns = array(
    ...
    "`transaction_id` BIGINT NOT NULL AUTO_INCREMENT , `origin_account_id` INT NOT NULL , `dest_account_id` INT NOT NULL , `transaction_type` ENUM('transfer','withdrawal','purchase','misc') NOT NULL DEFAULT 'transfer', `transaction_amount` INT NOT NULL , PRIMARY KEY (`transaction_id`)"
);
